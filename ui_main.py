...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\"><span style=\" font-size:48pt; font-weight:600; color:#ffffff;\"></span></p><p align=\"center\"><span style=\" font-size:24pt; color:#ffffff;\">Sistema de gerenciamento</span></p><p align=\"center\"><span style=\" font-size:24pt; color:#ffffff;\"><img src=\"_imgs/logo.png\"/></span></p></body></html>", None))
